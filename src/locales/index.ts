...
export const translations = {
  ru: {
    ...
    usersInfo: "Информация о зарегистрированных пользователях DevNet",
    activityOverview: "Обзор активности",
    userActivityStats: "Общая статистика пользовательской активности",
  ...
  en: {
    ...
    usersInfo: "Information about registered users of DevNet",
    activityOverview: "Activity Overview",
    userActivityStats: "General statistics of user activity",
