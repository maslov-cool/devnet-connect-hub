...
const AboutCreatorsPage = () => {
  ...
  const handleSaveEdit = () => {
    ...
    toast.success(t("Информация обновлена"));
  };
    ...
    <div className="container mx-auto px-4 py-12 max-w-5xl">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {creators.map((creator) => (
          <div key={creator.id} className="bg-card border rounded-lg p-6 relative hover:shadow-lg transition-shadow">
            {isEditing && (
              <Button
                variant="ghost"
                size="icon"
            ...
            <div className="flex flex-col items-center">
              <div className="w-32 h-32 rounded-full overflow-hidden mb-4 border-4 border-blue-900/30">
                <img 
                  src={creator.image} 
                  alt={creator.name}
              ...
              <p className="text-blue-900 dark:text-blue-300 mb-2">{creator.role}</p>
              ...
              {creator.link && (
                <a 
                  ...
                  className="flex items-center text-sm text-blue-900 dark:text-blue-300 hover:underline"
                >
        ...
        <div className="mt-12 text-center">
          <Dialog>
            <DialogTrigger asChild>
              <Button variant="outline" className="border-blue-900/50 hover:bg-blue-900/10">
                {t("Редактировать информацию")}
              </Button>
            </DialogTrigger>
            <DialogContent>
              <DialogHeader>
                <DialogTitle>
                  {t("Вход для редактирования")}
                </DialogTitle>
              </DialogHeader>
              ...
              <DialogFooter>
                <Button type="button" onClick={handleLogin} className="bg-blue-900 hover:bg-blue-800">
                  {t("login")}
                </Button>
              </DialogFooter>
            </DialogContent>
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="grid gap-4 py-4">
            <div className="flex justify-center mb-4">
              <div className="w-24 h-24 rounded-full overflow-hidden relative border-2 border-blue-900/30">
                <img 
          ...
          <DialogFooter>
            ...
            <Button type="button" onClick={handleSaveEdit} className="bg-blue-900 hover:bg-blue-800">
              {t("save")}
            </Button>
          </DialogFooter>
        </DialogContent>
